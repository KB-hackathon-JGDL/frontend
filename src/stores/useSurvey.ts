  ...
  actions: {
    saveToStorage() {
      try {
        ...
        localStorage.setItem('survey_recs', JSON.stringify(this.recommendations))
        localStorage.setItem('survey_completed', this.surveyCompleted ? '1' : '0')
      } catch {}
    },
    hydrateFromStorage() {
      try {
    ...
    hydrate() { this.hydrateFromStorage() },
    markSurveyCompleted() {
      ...
      this.questions = [
        {
          ...
          options: [
            ...
            { key: 'B', label: '사기당하지 않고 안전하게 지키고 싶다.', score: 3 },
        ...
        },
        {
          ...
          caption: '해당되는 항목에 체크해주세요.',
          options: [
            { key: 'A', label: '너무 어렵고, 누가 알려줬으면 좋겠다.', score: 3 },
        ...
        },
        {
          ...
          options: [
            ...
            { key: 'B', label: '학비, 기술 교육 등 미래를 위한 준비 자금', score: 1 },
            { key: 'C', label: '갑자기 아프거나 급한 일이 생겼을 때 쓸 돈', score: 2 },
          ],
        },
        {
          id: 4,
          ...
          caption: '해당되는 항목에 체크해주세요.',
          options: [
            { key: 'A', label: '불규칙해서 돈이 생길 때마다 아껴 쓴다.', score: 1 },
            { key: 'B', label: '정기적인 수입이 있어 계획을 세워 관리한다.', score: 3 },
        ...
        },
        {
          ...
          options: [
            ...
            { key: 'B', label: '가격 비교 후 마음에 들면 일단 사는 편이다.', score: 2 },
        ...
        },
        {
          ...
          options: [
            ...
            { key: 'B', label: '시도는 했지만 꾸준히 하기는 어렵다.', score: 2 },
            { key: 'C', label: '작은 돈보다는 큰돈을 모으는 게 효과적이다.', score: 1 },
          ],
        },
        {
          id: 7,
          ...
          caption: '해당되는 항목에 체크해주세요.',
          options: [
            { key: 'A', label: '안정적인 나만의 공간(보증금, 월세) 마련', score: 3 },
            { key: 'B', label: '원하는 공부나 기술을 배우기 위한 교육비 마련', score: 1 },
            { key: 'C', label: '평소 갖고 싶었던 물건 구매', score: 3 },
          ],
        },
        {
          id: 8,
          title: '8. 어떤 방식으로 저축하는 것이 가장 마음\n편하고 꾸준히 할 수 있을까요?',
          caption: '해당되는 항목에 체크해주세요.',
          options: [
            { key: 'A', label: '매달 같은 금액을 꾸준히 모으는 방식', score: 3 },
            { key: 'B', label: '돈이 생길 때마다 원하는 만큼 자유롭게 모으는 방식', score: 1 },
            { key: 'C', label: '단기간에 집중해서 바짝 모으는 방식', score: 2 },
          ],
        },
        {
          id: 9,
          title: '9. 카드나 통장을 고를 때,\n어떤 점이 가장 중요하다고\n생각하세요?',
          caption: '해당되는 항목에 체크해주세요.',
          options: [
            { key: 'A', label: '교통비, 편의점 등 할인/혜택', score: 3 },
            { key: 'B', label: '복잡한 조건 없이 쉬운 사용법', score: 1 },
            { key: 'C', label: '예쁘거나 좋아하는 캐릭터가 있는 디자인', score: 2 },
          ],
        },
      ]
    },
    ...
    derivePersona() {
      ...
      const PERSONAS_FULL = [
        {
          ...
          icon: 'shield',
          vec: { activity: 0.25, consume: 0.20, planning: 0.90, risk: 0.15 },
        },
        {
          key: 'planner',
          name: '현실적인 계획가',
          ...
          vec: { activity: 0.40, consume: 0.30, planning: 0.80, risk: 0.25 },
        },
        {
          key: 'explorer',
          name: '자유로운 탐험가',
          ...
          icon: 'compass',
          vec: { activity: 0.60, consume: 0.70, planning: 0.30, risk: 0.60 },
        },
        {
          key: 'smart',
          name: '스마트한 투자자',
          ...
          icon: 'brain',
          vec: { activity: 0.70, consume: 0.40, planning: 0.80, risk: 0.60 },
        },
        {
          key: 'relaxed',
          name: '느긋한 모험가',
          ...
          icon: 'leaf',
          vec: { activity: 0.50, consume: 0.50, planning: 0.50, risk: 0.40 },
        },
        {
          key: 'yolo',
          name: '현재를 즐기는 욜로족',
          ...
          icon: 'party-popper',
          vec: { activity: 0.80, consume: 0.70, planning: 0.30, risk: 0.65 },
        },
        {
          key: 'practical',
          name: '실용적 준비자',
          ...
          icon: 'wrench',
          vec: { activity: 0.35, consume: 0.30, planning: 0.60, risk: 0.25 },
        },
        {
          key: 'energizer',
          name: '비전 있는 자수성가형',
          ...
          icon: 'bolt',
          vec: { activity: 0.85, consume: 0.60, planning: 0.40, risk: 0.70 },
        },
      ] as const
      ...
      this.persona = { key: best.key, name: best.name, blurb: best.blurb, icon: best.icon }
      this.saveToStorage()
    },
