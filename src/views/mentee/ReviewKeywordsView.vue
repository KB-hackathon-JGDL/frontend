...
<template>
  <div class="min-h-dvh bg-[#F4F6FE]">
    <header
      class="relative z-20 h-[85px] bg-[#578FFD] text-white flex items-center px-5 border-0 shadow-none overflow-hidden"
    >
    ...
    <main class="px-5">
      <section class="mx-auto max-w-[520px]">
        <div class="relative">
          <div
            class="h-[160px] w-full rounded-[28px] bg-transparent -mt-14 shadow-[inset_0_1px_0_rgba(255,255,255,.7)]"
          />
          <div
            class="absolute left-1/2 top-1/5 -translate-x-1/2 -translate-y-[38%] w-[300px] h-[250px] rounded-2xl bg-white shadow-[0_20px_45px_rgba(0,0,0,0.15)] p-5 flex flex-col items-center justify-center text-center gap-3"
          >
            <img
            ...
            />
            <div class="space-y-4">
              <p class="font-semibold text-[16px] text-gray-900 leading-tight">
                상담사 김병로
              </p>
        ...
        <div class="mt-[190px] text-center">
          ...
          <p class="text-[13px] mt-2">
            <span class="relative text-[#4A79F6] font-semibold">
              이런 점이 좋았어요
              <span
                class="absolute left-0 right-0 -bottom-1 h-[7px] bg-[#FFD258]/55 rounded"
              ></span>
            </span>
        ...
        <div class="mt-10 flex flex-col items-center gap-0">
          <div class="flex justify-center gap-12">
            <KeywordChip
              ...
              class="px-8 h-12 text-[16px] text-[#578FFD] border-[#7BA7FD]"
            />
          </div>
          <div class="flex flex-col gap-10 w-[220px] mx-auto mt-10">
            <KeywordChip
              ...
              :active="store.selected.includes(k)"
              @click="store.toggle(k)"
              class="w-full text-[#578FFD] border-[#7BA7FD]"
            />
          </div>
        </div>
        ...
        <div class="mt-8 pb-12 grid place-items-center">
          <button
            class="w-[188px] h-20 rounded-full text-white disabled:opacity-50 mt-10 bg-[#FDB813] hover:opacity-90 shadow-[0_6px_14px_rgba(253,184,19,.45)]"
